...
from .models import ContactMessage, ExperienceHighlight, ExperienceItem, SiteProfile, StoryItem
...
class PortalApiTests(TestCase):
    def setUp(self):
        ...
        ExperienceHighlight.objects.create(
            ...
            text="Lead national innovation programs",
            sort_order=1,
        )
    ...
    def test_content_endpoint_returns_profile_data(self):
        ...
        self.assertEqual(len(payload["experience"][0]["highlights"]), 1)
