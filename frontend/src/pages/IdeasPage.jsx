...
export default function IdeasPage({ data }) {
  ...
  return (
    <>
      <Section title="Ideas" subtitle="Innovation concepts and impact pathways">
        <div className="cards">
          {data.ideas.map((item) => (
      ...
      <Section title="Idea Assets" subtitle="Images and files from backend">
        <div className="cards">
          {researchAssets.length ? (
            ...
            <article className="card subtle">
              <p className="muted">No idea assets are published yet.</p>
            </article>
          )}
        </div>
      </Section>
